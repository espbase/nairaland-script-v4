...
$PageSql = "SELECT * FROM `topics` WHERE post_type='newsfeed' ORDER BY topic_id DESC";
...
$ReadSql = "SELECT * FROM `topics` WHERE post_type='newsfeed' LIMIT $start, $perpage";
...
?>
<h2>LATEST HEADLINES / POST</h2>
<p><a href="<?php echo WEBROOT; ?>"><?php echo APPNAME; ?></a> /
	<a href="<?php echo WEBROOT; ?>/news/1">Latest Headlines Links</a>
</p>
