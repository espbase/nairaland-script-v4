...
############################### page title #######################
	...
	$page_title='Publish business- '.APPNAME;
	$site_dsc="Publish New business - ".APPNAME;
...
<p>Add Business to <?php echo APPNAME; ?></p>
         
   
<?php
$comQueryCheck=$db->query("SELECT * FROM directory WHERE user_fk='$user_id'");
...
if ($countBuz) {
	...
	<table><tbody><tr><th>Publish Your Business Free
     ...
     <?php
     echo "<h3 style='color:red'>You have reached your free limit to publish Business</h3>
<p>You next Business publish will be charge from your current ad balance</p>

<p>Users can  purchase directory space using credits incase they need to list any more listing on the directory</p>";
}
?>
   </td></tr></tbody></table>
   <?php
    ...
    for ($i = 0; $i < count($_FILES['file']['name']); $i++) {//loop to get individual element from the array
	  ...
	  if (($_FILES["file"]["size"][$i] < 1024*8068) //Approx. 100kb files can be uploaded.
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'][$i], $target_path.$imgurl)) {//if file moved to uploads folder
                    // save to databse
            	$mtk = $db->query("INSERT INTO directory (user_fk, bname, buzlogo, location, bdesc, baddress, bphone, bemail, bsite, bcat, bdate) 
    VALUES('$user_id', '$bname', '$imgurl', '$location', '$desc', '$address', '$phone', '$email', '$site', '$cat', NOW())");
    
    if ($countBuz) {
        $cost = $ses_adCredit-100;
        $pdateClicks=$db->query("UPDATE users SET ad_credit='$cost' WHERE uid='$uid'");
    }

                echo '<hr><h2 style="color:green; font-weight:bolder;">Your Business is Live Now</h2> ';
...
$mail->isHTML(true);
$mail->Subject ='Kenyans247 Business';
...
Your business name is now live and added to google search engine directory.<br>
...
<p><a title="Kenyans247 Forum" href="https://www.kenyans247.com" target="_blank" rel="noopener"><strong>KENYANS247 FORUM.</strong></a><br />Westlands Nairobi Kenya.</p>
...
<form enctype="multipart/form-data" action="" method="post">
 	<table>
		<tbody><tr>
				<td class="w"><b>Business Name:</b><input class="expansible_input" name="bname" required="" type="text"><br>
...
?>
			...
			<tr>
				<td class=""><b>Description</b>: <input class="expansible_input" id="baseUrl" required='' name="desc" type="text" ><br>
				(Short Note About your business, what you do and your services)</td>
			</tr>
			<tr>
				<td class="w"><b>Address</b>: <input class="expansible_input" id="baseUrl" required='' name="address" type="text" ><br>
				(Your Business Physical Address - landMark )</td>
			</tr>
			<tr>
				<td class=""><b>Phone No</b>: <input class="expansible_input" id="baseUrl" required='' name="phone" type="text" ><br>
				(Your Business Phone Number, pleasae include country code )</td>
			</tr>
			<tr>
				<td class="w"><b>Business Email</b>: <input class="expansible_input" id="baseUrl" required='' name="email" type="email" ><br>
				(Your Business Phone Number, pleasae include country code )</td>
			</tr>
			<tr>
				<td class=""><b>Website(opt)</b>: <input class="expansible_input" id="baseUrl" required='' name="site" type="text" value="http://www."><br>
