...
############################### page title #######################
	$user=$_GET['user'];
	$page_title=$user.'My Shared Post';
	$site_dsc=$user.'My Shared Post';
...
<div class="">
	...
	<div class="dark_box" style="border: none; text-align:center">
		<h2><?php echo ucfirst($ses_username); ?>'s Post Shared</h2>
...
<?php
	...
	$query_topic = $db->query("SELECT * FROM topics T, users U, sub_cat S, shares SH
		WHERE T.board_id_fk=S.sid AND T.user_id_fk=U.uid AND T.topic_id=SH.topic_id_fk AND SH.share_type='topic' AND SH.uid_fk='$ses_user_id' ORDER BY SH.topic_id_fk DESC  ");
	...
	echo '<tr>
	   ...
	   <img src="'.WEBROOT.'/icons/xx.gif"> <b>
	   	<span class="s"><b>Shared</b> by <b>You</b> On <b>'.$sdated.'</b> </span><br>
