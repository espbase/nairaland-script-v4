...
$PageSql = "SELECT * FROM `topics` WHERE post_type='post' ORDER BY topic_id DESC";
...
$ReadSql = "SELECT * FROM `topics` WHERE post_type='post' LIMIT $start, $perpage";
...
<p><a href="<?php echo WEBROOT; ?>"><?php echo APPNAME; ?></a> /
	<a href="<?php echo WEBROOT; ?>/links/1">Featured Links</a>
</p>
